...
class acfe_screen_post {
	...
	function __construct() {
		...
		// edit
		add_action('load-post-new.php', [$this, 'post_load']);
		add_action('load-post.php', [$this, 'post_load']);

		// list
		add_action('load-edit.php', [$this, 'posts_load']);
	...
	function post_load() {
		...
		// hooks
		add_action('add_meta_boxes', [$this, 'add_post_meta_boxes'], 10, 2);
	...
	function posts_load() {
		...
		// hooks
		add_action('admin_footer', [$this, 'posts_footer']);
