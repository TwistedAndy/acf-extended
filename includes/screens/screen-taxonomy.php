...
class acfe_screen_taxonomy {
	...
	function __construct() {
		...
		// edit
		add_action('load-term.php', [$this, 'term_load']);

		// list
		add_action('load-edit-tags.php', [$this, 'terms_load']);
	...
	function term_load() {
		...
		// hooks
		add_action("{$taxonomy}_term_edit_form_top", [$this, 'add_term_meta_boxes'], 10, 2);
		add_action("{$taxonomy}_edit_form", [$this, 'do_term_meta_boxes'], 10, 2);
