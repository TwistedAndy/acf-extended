...
class acfe_screen_attachment {
	...
	function __construct() {
		...
		// edit
		add_action('load-post.php', [$this, 'attachment_load']);

		// list
		add_action('load-upload.php', [$this, 'attachments_load']);
	...
	function attachment_load() {
		...
		// hooks
		add_action('add_meta_boxes', [$this, 'add_attachment_meta_boxes'], 10, 2);
	...
	function attachments_load() {
		...
		// hooks
		add_action('admin_footer', [$this, 'attachments_footer']);
