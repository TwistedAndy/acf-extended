...
class acfe_field_settings {
	...
	function __construct() {
		...
		// filters
		add_filter('acfe/load_field', [$this, 'load_field'], 20);
		add_filter('acfe/load_field', [$this, 'load_field_additional'], 20);
		add_filter('acf/prepare_field', [$this, 'prepare_field'], 20);
	...
	function add_settings() {
		...
		// exclude
		$exclude = ['accordion', 'acfe_column', 'tab'];
