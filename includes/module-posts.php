...
class acfe_module_posts {
	...
	function __construct() {
		...
		add_action('acfe/load_posts', [$this, 'load_posts']);
	...
	function load_posts($post_type) {
		...
		// get module
		$module = acfe_query_module(['post_type' => $post_type]);
		...
		add_filter('acfe/localize_data', [$this, 'localize_data']);
		add_filter("manage_{$module->post_type}_posts_columns", [$this, 'manage_columns']);
		add_action("manage_{$module->post_type}_posts_custom_column", [$this, 'manage_columns_html'], 10, 2);
		add_filter('display_post_states', [$this, 'display_post_states'], 10, 2);
		add_filter('post_row_actions', [$this, 'post_row_actions'], 10, 2);
		add_filter('page_row_actions', [$this, 'post_row_actions'], 10, 2);
		add_filter("bulk_actions-edit-{$module->post_type}", [$this, 'bulk_actions']);
		add_filter("handle_bulk_actions-edit-{$module->post_type}", [$this, 'handle_bulk_actions'], 10, 3);
