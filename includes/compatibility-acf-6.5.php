...
class acfe_compatibility_acf_65 {
	...
	function __construct() {
		...
		add_filter('acf/validate_field/type=flexible_content', [$this, 'validate_field'], 20);
		add_filter('acf/update_field/type=flexible_content', [$this, 'update_field'], 20);
		add_filter('acf/load_value/type=flexible_content', [$this, 'load_value_assign_legacy_value'], 10, 3);
		add_filter('acf/load_value/type=flexible_content', [$this, 'load_value_compat_toggle'], 15, 3);
		add_filter('acf/update_value/type=flexible_content', [$this, 'update_value_cleanup_legacy'], 15, 3);

		add_filter('acfe/flexible/layout_disabled', [$this, 'layout_disabled'], 15, 3);
		add_filter('acfe/flexible/layout_renamed', [$this, 'layout_renamed'], 15, 3);
