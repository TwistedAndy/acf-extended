...
class acfe_admin_settings_ui {
	...
	function admin_menu() {
		...
		$page = add_submenu_page('edit.php?post_type=acf-field-group', __('Settings'), __('Settings'), acf_get_setting('capability'), 'acfe-settings', [
			$this,
			'menu_html'
		]);

		add_action("load-{$page}", [$this, 'menu_load']);
	...
	function render_fields() {
		...
		foreach (['ACF', 'ACFE', 'AutoSync', 'Modules', 'Fields'] as $tab) {
