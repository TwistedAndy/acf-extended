...
class acfe_location_taxonomy_list {
	...
	function __construct() {
		...
		add_filter('acf/location/rule_values/taxonomy_list', [$this, 'rule_values']);
		add_filter('acf/location/rule_match/taxonomy_list', [$this, 'rule_match'], 10, 3);
	...
	function load_terms($taxonomy) {
		...
		if (acf_verify_nonce('taxonomy_list')) {
			...
			if (acf_validate_save_post(true)) {
				...
				// Redirect
				wp_redirect(add_query_arg(['message' => 'taxonomy_list']));
				exit;
