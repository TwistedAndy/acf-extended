...
class acfe_module_db {
	...
	function __construct() {
		...
		add_action('acfe/module/updated_item', [$this, 'updated_item'], 10, 2);
		add_action('acfe/module/trashed_item', [$this, 'deleted_item'], 10, 2);
		add_action('acfe/module/deleted_item', [$this, 'deleted_item'], 10, 2);
		add_action('acfe/module/include_items', [$this, 'include_items']);
