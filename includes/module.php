...
class acfe_module {
	...
	// vars
	public $name = '', $plural = '', $post_type = '', $args = [],

		$setting = '', $settings = '', $view = '', $register = '',

		$export_tool = '', $import_tool = '', $export_actions = ['php', 'json'], $export_files = [], $messages = [],

		$item = [], $validate = [], $columns = [], $alias = [], $l10n = [],
	...
	function __construct() {
		...
		$this->add_module_filter('acfe/module/register_field_groups', [$this, 'register_field_groups'], 9);
		$this->add_module_filter('acfe/module/register_items', [$this, 'register_items'], 9);
		$this->add_module_filter('acfe/module/register_item_args', [$this, 'register_item_args'], 9);
		$this->add_module_action('acfe/module/register_item', [$this, 'register_item'], 9);
		$this->add_module_action('acfe/module/load_post', [$this, 'load_post'], 9);
		$this->add_module_action('acfe/module/load_posts', [$this, 'load_posts'], 9);
		$this->add_module_filter('acfe/module/edit_columns', [$this, 'edit_columns'], 9);
		$this->add_module_action('acfe/module/edit_columns_html', [$this, 'edit_columns_html'], 9, 2);
		$this->add_module_filter('acfe/module/validate_save_item', [$this, 'validate_save_item'], 9);
		$this->add_module_filter('acfe/module/prepare_load_item', [$this, 'prepare_load_item'], 9);
		$this->add_module_filter('acfe/module/prepare_save_item', [$this, 'prepare_save_item'], 9);
		$this->add_module_action('acfe/module/updated_item', [$this, 'updated_item'], 9);
		$this->add_module_action('acfe/module/trashed_item', [$this, 'trashed_item'], 9);
		...
		$this->add_action('acfe/do_reset', [$this, 'reset']);
	...
	function get_field_groups() {
		return $this->apply_module_filters('acfe/module/register_field_groups', []);
	}
	...
	function validate_item($item = []) {
		...
		// default item
		$defaults = wp_parse_args($this->item, [
			'ID' => 0,
			'name' => '',
			'label' => '',
		]);
	...
	function update_item($item) {
		...
		add_filter('wp_insert_post_data', [$this, 'bypass_post_modified'], 1, 2);
		...
		remove_filter('wp_insert_post_data', [$this, 'bypass_post_modified'], 1);
 ...
 * @return false|mixed
 */
function acfe_query_module($query = []) {
 ...
 * @return false|mixed
 */
function acfe_query_modules($query = []) {
...
function acfe_get_module_by_post_type($post_type) {
	return acfe_query_module(['post_type' => $post_type]);
}
