...
class acfe_field_image extends acfe_field_extend {
	...
	function initialize() {
		...
		$this->add_filter('gettext', [$this, 'gettext'], 99, 3);
		$this->add_filter('acf/prepare_field/name=library', [$this, 'prepare_library']);
		$this->add_field_action('acf/render_field_settings', [$this, 'render_field_settings_before'], 0);
		$this->add_field_action('acf/render_field_settings', [$this, 'render_field_settings_after'], 15);
