...
class acfe_field_flexible_content_settings {
	...
	function __construct() {
		...
		// Hooks
		add_filter('acfe/flexible/defaults_field', [$this, 'defaults_field'], 4);
		add_filter('acfe/flexible/defaults_layout', [$this, 'defaults_layout'], 4);

		add_action('acfe/flexible/render_field_settings', [$this, 'render_field_settings'], 11);
		add_action('acfe/flexible/render_layout_settings', [$this, 'render_layout_settings'], 20, 3);

		add_filter('acfe/flexible/load_fields', [$this, 'load_fields'], 10, 2);
		add_filter('acfe/flexible/prepare_layout', [$this, 'prepare_layout'], 30, 5);
		add_filter('acfe/flexible/layouts/icons', [$this, 'layout_icons'], 30, 3);
	...
	function defaults_field($field) {
		...
		$field['acfe_flexible_modal_settings'] = [
