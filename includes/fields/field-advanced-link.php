...
class acfe_field_advanced_link extends acf_field {
	...
	function initialize() {
		...
		$this->add_action('wp_ajax_acfe/fields/advanced_link/post_query', [$this, 'ajax_query']);
		$this->add_action('wp_ajax_nopriv_acfe/fields/advanced_link/post_query', [$this, 'ajax_query']);
	...
	function get_ajax_query($options = []) {
		...
		$archives = [];
		$post_types_archives = acfe_get_post_types([
