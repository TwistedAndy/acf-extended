...
class acfe_field_flexible_content_select {
	...
	function __construct() {
		...
		add_filter('acfe/flexible/layouts/select_label', [$this, 'select_label'], 10, 3);

		add_action('acfe/flexible/render_popup_select', [$this, 'render_popup_select_open_wrapper'], 5);
		add_action('acfe/flexible/render_popup_select', [$this, 'render_popup_select_categories'], 7);
		add_action('acfe/flexible/render_popup_select', [$this, 'render_popup_select_before_layouts'], 9);
		add_action('acfe/flexible/render_popup_select', [$this, 'render_popup_select_close_wrapper'], 15);
	...
	function render_popup_select_categories($field) {
		...
		// wrapper filters
		$wrapper = ['class' => 'acfe-nav-tabs acfe-fc-categories'];
