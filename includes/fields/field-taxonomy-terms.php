...
class acfe_field_taxonomy_terms extends acfe_field {
	...
	function initialize() {
		...
		// actions
		$this->add_action('acf/save_post', [$this, 'save_post'], 15, 1);

		// ajax
		$this->add_action('wp_ajax_acfe/fields/taxonomy_terms/allow_query', [$this, 'ajax_query_allowed_terms']);
		$this->add_action('wp_ajax_nopriv_acfe/fields/taxonomy_terms/allow_query', [$this, 'ajax_query_allowed_terms']);

		$this->add_action('wp_ajax_acf/fields/acfe_taxonomy_terms/query', [$this, 'ajax_query']);
		$this->add_action('wp_ajax_nopriv_acf/fields/acfe_taxonomy_terms/query', [$this, 'ajax_query']);
	 ...
	 * @return array[]
	 */
	function get_ajax_query_allowed_terms($options = []) {
	...
	function load_value($value, $post_id, $field) {
		...
		if ($field['load_terms']) {
			...
			$term_ids = wp_get_object_terms($info['id'], $taxonomy, ['fields' => 'ids', 'orderby' => 'none']);
