...
class acfe_field_flexible_content_hooks {
	...
	function __construct() {
		...
		add_action('acfe/flexible/render_layout_settings', [$this, 'render_layout_settings'], 9, 3);
		add_filter('acfe/flexible/layouts/label_prepend', [$this, 'layout_label_prepend'], 9, 3);
		add_filter('acfe/flexible/layouts/label_atts', [$this, 'layout_label_atts'], 9, 3);
		add_filter('acfe/flexible/load_fields', [$this, 'load_fields'], 9, 2);
		add_filter('acfe/flexible/layouts/model', [$this, 'layout_model'], 9, 3);
		add_filter('acfe/flexible/div_values', [$this, 'div_values'], 9, 2);
		add_filter('acfe/flexible/remove_actions', [$this, 'remove_actions'], 9, 3);
		add_filter('acfe/flexible/action_wrapper', [$this, 'action_wrapper'], 9, 3);
		add_action('acfe/flexible/render_popup', [$this, 'render_popup'], 9, 1);
		add_filter('acfe/flexible/layouts/div', [$this, 'layout_div'], 9, 6);
		add_filter('acfe/flexible/prepare_layout', [$this, 'prepare_layout'], 9, 5);
		add_action('acfe/flexible/pre_render_layout', [$this, 'pre_render_layout'], 9, 5);
		add_action('acfe/flexible/render_layout', [$this, 'render_layout'], 9, 5);
		add_filter('acfe/flexible/layouts/handle', [$this, 'layout_handle'], 9, 6);
		add_action('acfe/flexible/layouts/controls', [$this, 'layout_controls'], 9, 5);
		add_filter('acfe/flexible/action_button', [$this, 'action_button'], 9, 3);
		add_filter('acfe/flexible/action_buttons', [$this, 'action_buttons'], 9, 3);
		add_filter('acf/fields/flexible_content/layout_attrs', [$this, 'layout_attrs'], 9, 4);
		add_filter('acfe/flexible/layouts/handle_elements', [$this, 'handle_elements'], 9, 6);
		add_filter('acfe/flexible/layouts/icons', [$this, 'layout_icons'], 9, 3);
		add_filter('acfe/flexible/layout_disabled', [$this, 'layout_disabled'], 9, 3);
		add_filter('acfe/flexible/layout_renamed', [$this, 'layout_renamed'], 9, 3);
