...
class acfe_field_flexible_content_compatibility {
	...
	function __construct() {
		...
		add_filter('acfe/flexible/layouts/handle_elements', [$this, 'handle_elements'], 0, 6);
		add_filter('acfe/flexible/layouts/icons', [$this, 'layouts_icons'], 0, 3);
		add_filter('acfe/flexible/layouts/icons', [$this, 'layouts_icons_settings'], 31, 3);
		add_filter('acfe/flexible/layouts/icons', [$this, 'layouts_icons_edit'], 51, 3);
		add_filter('acfe/flexible/remove_actions', [$this, 'remove_actions'], 50, 3);
		add_filter('acfe/flexible/wrapper_attributes', [$this, 'wrapper_attributes'], 10, 2);
		add_filter('acfe/flexible/validate_field', [$this, 'validate_field']);
