...
class acfe_compatibility {
	...
	function __construct() {
		...
		add_filter('acf/validate_field/type=acfe_column', [$this, 'field_column'], 20);
		add_filter('acf/validate_field/type=image', [$this, 'field_image'], 20);
		add_filter('acf/validate_field/type=file', [$this, 'field_image'], 20);
		add_filter('acf/validate_field/type=acfe_forms', [$this, 'field_forms'], 20);
		add_filter('acf/validate_field/type=acfe_code_editor', [$this, 'field_code_editor'], 20);
