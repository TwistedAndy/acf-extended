...
class acfe_dev_delete_meta {
	...
	function __construct() {
		...
		// table
		add_filter('acfe/dev/meta/row_actions', [$this, 'meta_row_actions'], 10, 3);
		add_action('acfe/dev/meta/after_table', [$this, 'meta_after_table']);

		// ajax
		add_action('wp_ajax_acfe/dev/single_delete_meta', [$this, 'ajax_delete_single_meta']);
		add_action('wp_ajax_acfe/dev/bulk_delete_meta', [$this, 'ajax_delete_bulk_meta']);
