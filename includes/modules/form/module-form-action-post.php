...
class acfe_form_post {
	...
	function __construct() {
		 ...
		 * Action
		 */
		add_filter('acfe/form/actions', [$this, 'add_action']);
		add_filter('acfe/form/load/post', [$this, 'load'], 10, 3);
		add_action('acfe/form/make/post', [$this, 'make'], 10, 3);
		add_action('acfe/form/submit/post', [$this, 'submit'], 10, 5);

		/*
		 * Admin
		 */
		add_filter('acf/prepare_field/name=acfe_form_post_save_meta', [$helpers, 'map_fields']);
		add_filter('acf/prepare_field/name=acfe_form_post_load_meta', [$helpers, 'map_fields']);

		add_filter('acf/prepare_field/name=acfe_form_post_save_target', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_load_source', [$helpers, 'map_fields_deep']);

		add_filter('acf/prepare_field/name=acfe_form_post_save_post_type', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_status', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_title', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_name', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_content', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_excerpt', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_author', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_parent', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_terms', [$helpers, 'map_fields_deep']);

		add_filter('acf/prepare_field/name=acfe_form_post_map_post_type', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_status', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_title', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_name', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_content', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_excerpt', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_author', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_parent', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_post_map_post_terms', [$helpers, 'map_fields_deep_no_custom']);

		add_filter('acf/prepare_field/name=acfe_form_post_save_target', [$this, 'prepare_choices'], 5);
		add_filter('acf/prepare_field/name=acfe_form_post_load_source', [$this, 'prepare_choices'], 5);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_parent', [$this, 'prepare_choices'], 5);
		add_filter('acf/prepare_field/name=acfe_form_post_save_post_author', [$this, 'prepare_choices_users'], 5);
	...
	function submit($_post_id, $post_action, $args, $form, $action) {
		...
		// Deprecated
		$post_object = apply_filters_deprecated("acfe/form/query_var/post", [
			$post_object,
			$_post_id,
			$post_action,
			$args,
			$form,
			$action
		], '0.8.7.5', "acfe/form/output/post");
		$post_object = apply_filters_deprecated("acfe/form/query_var/post/form={$form_name}", [
			$post_object,
			$_post_id,
			$post_action,
			$args,
			$form,
			$action
		], '0.8.7.5', "acfe/form/output/post/form={$form_name}");
		$post_object = apply_filters_deprecated("acfe/form/query_var/post/action={$action}", [
			$post_object,
			$_post_id,
			$post_action,
			$args,
			$form,
			$action
		], '0.8.7.5', "acfe/form/output/post/action={$action}");
		...
		add_filter('acf/update_value/type=file', [$this, 'update_file_value'], 20, 3);
		add_filter('acf/update_value/type=image', [$this, 'update_file_value'], 20, 3);
		add_filter('acf/update_value/type=gallery', [$this, 'update_file_value'], 20, 3);
		...
		remove_filter('acf/update_value/type=file', [$this, 'update_file_value'], 20);
		remove_filter('acf/update_value/type=image', [$this, 'update_file_value'], 20);
		remove_filter('acf/update_value/type=gallery', [$this, 'update_file_value'], 20);
