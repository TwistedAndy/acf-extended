...
class acfe_dynamic_forms_hooks {
	...
	function __construct() {
		...
		// Fields
		add_filter('acf/load_value/name=acfe_form_custom_html_enable', [$this, 'prepare_custom_html'], 10, 3);
		add_filter('acf/prepare_field/name=acfe_form_actions', [$this, 'prepare_actions']);
		add_filter('acf/prepare_field/name=acfe_form_field_groups', [$this, 'field_groups_choices']);
		add_filter('acf/prepare_field/name=acfe_form_return', [$this, 'form_return_deprecated']);

		// Format values
		add_filter('acfe/form/format_value/type=post_object', [$this, 'format_value_post_object'], 5, 4);
		add_filter('acfe/form/format_value/type=relationship', [$this, 'format_value_post_object'], 5, 4);
		add_filter('acfe/form/format_value/type=user', [$this, 'format_value_user'], 5, 4);
		add_filter('acfe/form/format_value/type=taxonomy', [$this, 'format_value_taxonomy'], 5, 4);
		add_filter('acfe/form/format_value/type=image', [$this, 'format_value_file'], 5, 4);
		add_filter('acfe/form/format_value/type=file', [$this, 'format_value_file'], 5, 4);
		add_filter('acfe/form/format_value/type=select', [$this, 'format_value_select'], 5, 4);
		add_filter('acfe/form/format_value/type=checkbox', [$this, 'format_value_select'], 5, 4);
		add_filter('acfe/form/format_value/type=radio', [$this, 'format_value_select'], 5, 4);
		add_filter('acfe/form/format_value/type=google_map', [$this, 'format_value_google_map'], 5, 4);
		add_filter('acfe/form/format_value/type=repeater', [$this, 'format_value_repeater'], 5, 4);
		add_filter('acfe/form/format_value/type=acfe_date_range_picker', [$this, 'format_value_date_range_picker'], 5, 4);
	...
	function field_groups_choices($field) {
		...
		$hidden = acfe_get_setting('reserved_field_groups', []);
