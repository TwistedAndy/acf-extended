...
class acfe_dynamic_forms extends acfe_dynamic_module {
	...
	function actions() {
		...
		// Validate
		add_filter('acf/validate_value/name=acfe_form_name', [$this, 'validate_name'], 10, 4);

		// Save
		add_action('acfe/form/save', [$this, 'save'], 10, 2);

		// Import
		add_action('acfe/form/import_fields', [$this, 'import_fields'], 10, 3);
	...
	function post_head() {
		...
		// Add Instructions
		add_meta_box('acfe-form-integration', 'Integration', [$this, 'meta_box_side'], $this->post_type, 'side', 'core');

		if ($this->field_groups) {
			add_meta_box('acfe-form-details', __('Fields', 'acf'), [$this, 'meta_box_field_groups'], $this->post_type, 'normal');
		}
	...
	function meta_box_side($post) {
		...
		<div class="acf-field">
			...
			<div class="acf-input">
				...
				<ul style="list-style:inside;">
					...
					<li>
						<a href="https://www.acf-extended.com/features/modules/dynamic-forms/form-cheatsheet" target="_blank"><?php _e('Cheatsheet', 'acfe'); ?></a>
					</li>
					<li><a href="https://www.acf-extended.com/features/modules/dynamic-forms/form-hooks" target="_blank"><?php _e('Hooks', 'acfe'); ?></a>
					</li>
					<li>
						<a href="https://www.acf-extended.com/features/modules/dynamic-forms/form-helpers" target="_blank"><?php _e('Helpers', 'acfe'); ?></a>
					</li>
				</ul>
		...
		<div class="acf-field">
			...
			<div class="acf-input">
				...
				<code>[acfe_form ID="<?php echo $form_id; ?>"]</code>
				<br />
				<br />
...
&lt;?php get_footer(); ?&gt;</pre>
	...
	function meta_box_field_groups() {
		...
		foreach ($this->field_groups as $field_group) { ?>
			...
			<div class="acf-field">
				...
				<div class="acf-label">
					<label><a href="<?php echo admin_url("post.php?post={$field_group['ID']}&action=edit"); ?>"><?php echo $field_group['title']; ?></a>
					</label>
	...
	function export_data($name) {
		...
		$args = array_merge(['title' => get_the_title($form->ID)], get_fields($form->ID, false));
	...
	function add_local_field_group() {
		...
		$actions_layouts = apply_filters('acfe/form/actions', []);
