...
class acfe_form_custom {
	...
	function __construct() {
		...
		add_action('acfe/form/make/custom', [$this, 'make'], 10, 3);
		add_filter('acf/validate_value/name=acfe_form_custom_action', [$this, 'validate_action'], 10, 4);
	...
	function validate_action($valid, $value, $field, $input) {
		...
		$reserved = ['custom', 'email', 'post', 'option', 'redirect', 'term', 'user'];
