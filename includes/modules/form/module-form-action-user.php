...
class acfe_form_user {
	...
	function __construct() {
		...
		add_filter('acfe/form/load/user', [$this, 'load'], 10, 3);
		add_action('acfe/form/validation/user', [$this, 'validation'], 10, 3);
		add_action('acfe/form/make/user', [$this, 'make'], 10, 3);
		add_action('acfe/form/submit/user', [$this, 'submit'], 10, 5);

		/*
		 * Admin
		 */
		add_filter('acf/prepare_field/name=acfe_form_user_save_meta', [$helpers, 'map_fields']);
		add_filter('acf/prepare_field/name=acfe_form_user_load_meta', [$helpers, 'map_fields']);

		add_filter('acf/prepare_field/name=acfe_form_user_save_login_user', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_login_pass', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_login_remember', [$helpers, 'map_fields_deep']);

		add_filter('acf/prepare_field/name=acfe_form_user_save_target', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_load_source', [$helpers, 'map_fields_deep']);

		add_filter('acf/prepare_field/name=acfe_form_user_save_email', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_username', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_password', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_first_name', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_last_name', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_nickname', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_display_name', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_website', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_description', [$helpers, 'map_fields_deep']);
		add_filter('acf/prepare_field/name=acfe_form_user_save_role', [$helpers, 'map_fields_deep']);

		add_filter('acf/prepare_field/name=acfe_form_user_map_email', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_username', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_password', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_first_name', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_last_name', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_nickname', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_display_name', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_website', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_description', [$helpers, 'map_fields_deep_no_custom']);
		add_filter('acf/prepare_field/name=acfe_form_user_map_role', [$helpers, 'map_fields_deep_no_custom']);

		add_filter('acf/prepare_field/name=acfe_form_user_save_target', [$this, 'prepare_choices'], 5);
		add_filter('acf/prepare_field/name=acfe_form_user_load_source', [$this, 'prepare_choices'], 5);
	...
	function validation($form, $current_post_id, $action) {
		...
		// filters
		$errors = apply_filters_deprecated('acfe/form/validation/user/login_errors', [$errors], '0.8.8.8', 'acfe/form/validation/user_errors');
	...
	function submit($_user_id, $user_action, $args, $form, $action) {
		...
		if (isset($user_object->data)) {
			...
			// Deprecated
			$user_array = apply_filters_deprecated("acfe/form/query_var/user", [
				$user_array,
				$_user_id,
				$user_action,
				$args,
				$form,
				$action
			], '0.8.7.5', "acfe/form/output/user");
			$user_array = apply_filters_deprecated("acfe/form/query_var/user/form={$form_name}", [
				$user_array,
				$_user_id,
				$user_action,
				$args,
				$form,
				$action
			], '0.8.7.5', "acfe/form/output/user/form={$form_name}");
			$user_array = apply_filters_deprecated("acfe/form/query_var/user/action={$action}", [
				$user_array,
				$_user_id,
				$user_action,
				$args,
				$form,
				$action
			], '0.8.7.5', "acfe/form/output/user/action={$action}");
