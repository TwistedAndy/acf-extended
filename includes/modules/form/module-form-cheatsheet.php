...
class acfe_dynamic_forms_cheatsheet {
	...
	function __construct() {
		...
		add_action('acf/render_field/name=acfe_form_cheatsheet_field', [$this, 'field']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_fields', [$this, 'fields']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_get_field', [$this, 'get_field']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_get_option', [$this, 'get_option']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_query_var', [$this, 'query_var']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_current_form', [$this, 'current_form']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_actions_post', [$this, 'actions_post']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_actions_term', [$this, 'actions_term']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_actions_user', [$this, 'actions_user']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_actions_email', [$this, 'actions_email']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_request', [$this, 'request']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_current_post', [$this, 'current_post']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_current_term', [$this, 'current_term']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_current_user', [$this, 'current_user']);
		add_action('acf/render_field/name=acfe_form_cheatsheet_current_author', [$this, 'current_author']);
	...
	function actions_post($field) {
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>Last Post Action</strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>Post Action Named <code>my-post</code></strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
	...
	function actions_term($field) {
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>Last Term Action</strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>Term Action Named <code>my-term</code></strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
	...
	function actions_user($field) {
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>Last User Action</strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>User Action Named <code>my-user</code></strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
	...
	function actions_email($field) {
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>Last Email Action</strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
		...
		<table class="acf-table">
			<thead>
			<tr>
				<th colspan="2"><strong>Email Action Named <code>my-email</code></strong></th>
			</tr>
			</thead>
			<tbody>
			<tr class="acf-row">
