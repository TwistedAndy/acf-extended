...
class acfe_module_block_type extends acfe_module {
	...
	function initialize() {
		...
		$this->l10n = ['title', 'description'];

		// register variations
		acf_add_filter_variations('acfe/block_type/prepend/template', ['name'], 1);
		acf_add_filter_variations('acfe/block_type/prepend/style', ['name'], 1);
		acf_add_filter_variations('acfe/block_type/prepend/script', ['name'], 1);
	...
	function prepare_load_item($item) {
		...
		// supports
		$supports = ['anchor', 'jsx', 'align', 'align_text', 'align_content', 'full_height', 'mode', 'multiple'];
