...
class acfe_performance_ui {
	...
	function __construct() {
		...
		add_action('acfe/dev/add_meta_boxes', [$this, 'add_meta_boxes'], 10, 3);
		add_filter('acfe/dev/meta_ref', [$this, 'meta_ref'], 10, 6);
		add_filter('acfe/modules/performance/config', [$this, 'get_config'], 99);
	...
	function add_meta_boxes($post_id, $screen, $type) {
		...
		// add meta box
		add_meta_box('acfe-performance', __('Performance Mode', 'acfe'), [$this, 'render_metabox'], $screen, 'side', 'core', ['post_id' => $post_id]);
	...
	function render_metabox($post, $metabox) {
		...
		<script type="text/javascript">
			if (typeof acf !== 'undefined') {
				acf.newPostbox(<?php echo json_encode([
					'id' => 'acfe-performance',
					'key' => '',
					'style' => '',
					'label' => '',
