...
if (!class_exists('acfe_performance')) {
	...
	class acfe_performance {
		...
		function __construct() {
			...
			// hooks
			$this->add_filter('acf/pre_load_meta', [$this, 'pre_load_meta'], 999, 2);
			$this->add_filter('acf/pre_load_metadata', [$this, 'pre_load_metadata'], 999, 4);
			$this->add_filter('acf/pre_update_metadata', [$this, 'pre_update_metadata'], 999, 5);
			$this->add_filter('acf/pre_delete_metadata', [$this, 'pre_delete_metadata'], 999, 4);
			$this->add_filter('acf/update_value', [$this, 'update_value'], 999, 3);
			$this->add_action('acf/save_post', [$this, 'pre_save_post'], 1);
			$this->add_action('acf/save_post', [$this, 'save_post'], 999);
 ...
 * @return false|mixed
 */
function acfe_query_performance_engine($query = [], $operator = 'AND') {
 ...
 * @return false|mixed
 */
function acfe_query_performance_engines($query = [], $operator = 'AND') {
