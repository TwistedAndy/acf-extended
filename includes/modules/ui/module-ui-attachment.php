...
class acfe_enhanced_ui_attachment extends acfe_enhanced_ui {
	...
	function initialize() {
		...
		// load
		add_action('acfe/load_attachment', [$this, 'load_attachment']);
	...
	function load_attachment($post_id) {
		...
		acfe_remove_action('attachment_fields_to_edit', ['acf_form_attachment', 'edit_attachment']);
		...
		// footer
		add_action('acf/admin_footer', [$this, 'admin_footer']);
