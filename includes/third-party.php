...
class acfe_third_party {
	...
	function __construct() {
		...
		add_filter('pto/posts_orderby/ignore', [$this, 'pto_posts_orderby_ignore'], 10, 3);
		add_filter('pto/get_options', [$this, 'pto_get_options']);
		add_action('admin_menu', [$this, 'cotto_submenu'], 999);
		...
		add_filter('pll_get_post_types', [$this, 'polylang_get_post_types'], 10, 2);
		add_action('elementor/documents/register_controls', [$this, 'elementor_register_controls']);
		add_filter('wpgraphql_acf_supported_fields', [$this, 'wpgraphql_acf_supported_fields']);
		add_filter('wpgraphql_acf_register_graphql_field', [$this, 'wpgraphql_acf_register_graphql_field'], 10, 4);
